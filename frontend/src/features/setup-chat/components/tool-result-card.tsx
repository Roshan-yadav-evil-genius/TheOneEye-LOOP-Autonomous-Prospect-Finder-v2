...
export function ToolResultCard({ name, content, rules }: { name: string; content: string; rules?: ToolCustomizationRuleRead[] }) {
  ...
  return (
    <details className="tool-result-card" style={{ marginBottom: '8px', padding: '8px', background: backgroundColor, border: '1px solid var(--color-border-default)', borderRadius: 'var(--radius-md)' }}>
