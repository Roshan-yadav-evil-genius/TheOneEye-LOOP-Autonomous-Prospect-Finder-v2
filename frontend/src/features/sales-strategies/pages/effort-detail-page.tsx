...
export function EffortDetailPage({ role }: { role: 'company-finder' | 'contact-finder' }) {
  ...
  // 0. Load Strategy Context for Breadcrumbs
  useEffect(() => {
    if (strategyId) void loadContext(strategyId)
  ...
  return (
    <SplitFormChatLayout
      ...
      leftPanelStyle={{ flex: '0 0 300px', padding: 0 }}
      rightPanelStyle={{ flex: 1, padding: 0 }}
      leftPanel={
