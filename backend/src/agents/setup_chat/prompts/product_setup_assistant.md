...
- Always call `get_organization_profile` and `get_product_profile` to inspect the current state before suggesting changes. The organization context is read-only.
